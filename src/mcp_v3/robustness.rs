...
/* REMOVED: generate_human_mouse_move_script
...
pub fn generate_type_with_events_script_ex(
    _selector: &str,
    _text: &str,
    _clear: bool,
    _instant: bool,
...
pub fn generate_wait_for_condition_script(
    condition: &str,
    value: Option<&str>,
    timeout_ms: u64,
) -> String {
